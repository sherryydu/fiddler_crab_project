...
This folder contains cleaned (out) data of the Fiddler crab project in .csv format (i.e., 'Du_FiddlerCrabProject_Data-out_V0.csv'), and the accompanying _DATA-DICTIONARY.Rmd describing the metadata associated with this dataset. For more information on the METADATA of this dataset, please see DATA-DICTIONARY.Rmd in this folder (i.e., 02_outdata).
